function [R,T,P,error]=ReflectionTM(lambda,refractive_index,thickness,theta,Length,User_selection)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  ReflectionTM.m                                                   %
%  Date: 2/13/2001                                                  %
%  Version: 1.3                                                     %
...
%                                                                   %
%  Description:  ReflectionTM.m calculates the reflection and       %
...
%           refractive_index == index matrix  ((x;:)matrix)         %
...
%   eta(:,j)=Y.*refractive_index(:,j)./cos(thetam(:,j)); %TM Polarization layers index
